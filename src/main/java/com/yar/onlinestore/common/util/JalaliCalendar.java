package com.yar.onlinestore.common.util;
...
public class JalaliCalendar extends Calendar {
    ...
    public static String gregorianToJalali(Date date) {
        ...
        YearMonthDate gregorian = new YearMonthDate(date.getYear(),date.getMonth(),date.getDay());

        return gregorianToJalali(gregorian).toString();
    }
    ...
    public String getJalaliDate(Date gDate) {
        ...
        String date = (String.valueOf(jDate.date).length() < 2 ? ("0" + String.valueOf(jDate.date)) : String.valueOf(jDate.date));
        String month = (String.valueOf(jDate.month + 1).length() < 2 ? ("0" + String.valueOf(jDate.month + 1)) : String.valueOf(jDate.month + 1));

        return jDate.year + "/" + month + "/" + date;
    }
    ...
    public static class YearMonthDate {
        ...
        /**
         * constructor of YearMonthDate
         * @param dateStr
         * #Format MM/dd/yyyy
         */
        public YearMonthDate(String dateStr) {
            String[] splitedDate = dateStr.split("/");

            this.year = Integer.parseInt(splitedDate[2]);
            this.month = Integer.parseInt(splitedDate[0]);
            this.date = Integer.parseInt(splitedDate[1]);
        }

...
public class DatabaseLoggingAspect implements LogFactory {
     ...
     */
    @Before("execution(* com.stts.onlinestore.dao..*.*(..))")
     ...
     * @param joinPoint join point of aspectJ component
     */
    @After("execution(* com.stts.onlinestore.dao..*.*(..))")
     ...
     */
    @AfterThrowing(pointcut = "execution(* com.stts.onlinestore.dao..*.*(..))" , throwing = "exception")

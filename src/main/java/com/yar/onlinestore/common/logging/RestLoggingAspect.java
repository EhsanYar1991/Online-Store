...
public class RestLoggingAspect implements LogFactory {
     ...
     */
    @Before("execution(* com.yar.onlinestore.controller.rest..*.*(..))")
     ...
     * @param joinPoint join point of aspectJ component
     */
    @After("execution(* com.yar.onlinestore.controller.rest..*.*(..))")
     ...
     */
    @AfterThrowing(pointcut = "execution(* com.yar.onlinestore.controller.rest..*.*(..))" , throwing = "exception")
